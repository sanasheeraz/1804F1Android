...
public class Employee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper=new DataBaseHelper(Employee.this);
        ...
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(Employee.this,R.layout.support_simple_spinner_dropdown_item,lstDeptName);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if(result)
                    {
                        Toast.makeText(Employee.this, "EmployeeAdded Succesfully", Toast.LENGTH_SHORT).show();
                    }else
                    {
                        Toast.makeText(Employee.this, "Employee Not Added", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(Employee.this,View_Employee.class);
